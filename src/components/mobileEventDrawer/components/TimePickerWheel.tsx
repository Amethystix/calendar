...
export const TimePickerWheel: React.FC<TimePickerWheelProps> = ({ date, onChange }) => {
    ...
    const onScroll = (e: React.UIEvent<HTMLDivElement>, type: 'hour' | 'minute') => {
        ...
        if (type === 'hour') {
            ...
            } else if (scrollTop > 50 * itemHeight) { // Near bottom of 2nd set
                scrollTop -= totalHeight;
                target.scrollTop = scrollTop;
            }
                ...
                {hours.map((h, i) => (
                    <div
                        ...
                        onClick={() => {
                            ...
                            newDate.setHours(h);
                            onChange(newDate);
                            hourRef.current?.scrollTo({ top: i * itemHeight, behavior: 'smooth' });
                        }}
                    >
                        <div
                ...
                {minutes.map((m, i) => (
                    <div
                        ...
                        onClick={() => {
                            ...
                            newDate.setMinutes(m);
                            onChange(newDate);
                            minRef.current?.scrollTo({ top: i * itemHeight, behavior: 'smooth' });
                        }}
                    >
                        <div
